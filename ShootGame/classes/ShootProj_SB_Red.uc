class ShootProj_SB_Red extends ShootProjectile;
...
DefaultProperties
{
	ProjFlightTemplate=ParticleSystem'WP_LinkGun.Effects.P_FX_LinkGun_3P_Beam_MF_Red'
